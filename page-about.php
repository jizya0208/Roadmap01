<?php get_header(); ?>
   <section class="p-about">
      <div class="container">
         ...
         <p class="txt">Webデザイナー能力試験エキスパート、ウェブ解析士、GAIQ、色彩検定２級</p>
         <div class="heading">あいさつ</div>
         <p class="txt">はじめまして！●●●と申します。お仕事のご依頼をお待ちしております！あのイーハトーヴォのすきとおった風、夏でも底に冷たさをもつ青いそら、うつくしい森で飾られたモリーオ市、郊外のぎらぎらひかる草の波。</p>
      </div>
   </section>
<?php get_footer(); ?>